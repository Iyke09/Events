module.exports = {
  'Render landing page': (client) => {
    client
      ...
      .verify.containsText('h3', 'Major Events Center')
  ...
  'Redirect to signin page if user is not authenticated and trying to book center': (client) => {
    client
      ...
      .verify.containsText('h1', 'Mason')
      .verify.containsText('.location', '78 airport road,maryland. california')
      .verify.visible('#eventz')
